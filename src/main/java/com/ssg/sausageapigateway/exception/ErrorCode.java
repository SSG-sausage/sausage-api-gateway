...
import static com.ssg.sausageapigateway.exception.ErrorStatusCode.BAD_GATEWAY;
import static com.ssg.sausageapigateway.exception.ErrorStatusCode.BAD_REQUEST;
import static com.ssg.sausageapigateway.exception.ErrorStatusCode.FORBIDDEN;
import static com.ssg.sausageapigateway.exception.ErrorStatusCode.INTERNAL_SERVER;
import static com.ssg.sausageapigateway.exception.ErrorStatusCode.NOT_FOUND;
import static com.ssg.sausageapigateway.exception.ErrorStatusCode.SERVICE_UNAVAILABLE;
import static com.ssg.sausageapigateway.exception.ErrorStatusCode.UNAUTHORIZED;
...
public enum ErrorCode {
    ...
    NOT_FOUND_HEADER_MBR_ID_EXCEPTION(NOT_FOUND, "멤버 ID 헤더값이 존재하지 않습니다."),
